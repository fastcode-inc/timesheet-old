...
import { IAppConfiguration, AppConfigurationService, AppConfigurationDetailsComponent, AppConfigurationListComponent,
	AppConfigurationNewComponent } from '../';
...
describe('AppConfigurationListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/appconfiguration/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
