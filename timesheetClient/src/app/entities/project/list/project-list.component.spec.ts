...
import { IProject, ProjectService, ProjectDetailsComponent, ProjectListComponent,
	ProjectNewComponent } from '../';
...
describe('ProjectListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/project/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
