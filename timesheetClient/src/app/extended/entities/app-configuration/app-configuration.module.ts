...
import { AppConfigurationExtendedService, AppConfigurationDetailsExtendedComponent, AppConfigurationListExtendedComponent, AppConfigurationNewExtendedComponent } from './';
...
const entities = [
    AppConfigurationDetailsExtendedComponent, AppConfigurationListExtendedComponent, AppConfigurationNewExtendedComponent 
  ]
@NgModule({
