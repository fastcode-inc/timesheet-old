...
public class CustomerControllerTest {
	...
	public void setup() {
		...
		final CustomerController customerController = new CustomerController(customerAppService, projectAppService,
	logHelper,env);
	...
	public void GetProjects_searchIsNotEmptyAndPropertyIsNotValid_ThrowException() {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/customer/1/projects?search=abc[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void GetProjects_searchIsNotEmptyAndPropertyIsValid_ReturnList() throws Exception {
        ...
        Mockito.when(customerAppService.parseProjectsJoinColumn("customerid")).thenReturn(joinCol);
		mvc.perform(get("/customer/1/projects?search=customerid[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	    		  .andExpect(status().isOk());
	}  
	...
	public void GetProjects_searchIsNotEmpty() {
	    ...
	    org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(get("/customer/1/projects?search=customerid[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
