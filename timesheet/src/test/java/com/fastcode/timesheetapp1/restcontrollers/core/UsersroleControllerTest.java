...
public class UsersroleControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table timesheet.usersrole RESTART IDENTITY").executeUpdate();
	...
	public void UpdateUsersrole_UsersroleDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		String json = ow.writeValueAsString(usersrole);
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(put("/usersrole/roleId=999,usersId=999").contentType(MediaType.APPLICATION_JSON).content(json))
	...
	public void FindAll_SearchIsNotNullAndPropertyIsNotValid_ThrowException() throws Exception {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/usersrole?search=usersroleroleId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new Exception("Wrong URL Format: Property usersroleroleId not found!"));
