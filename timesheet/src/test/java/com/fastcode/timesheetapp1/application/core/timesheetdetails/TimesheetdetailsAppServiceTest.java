...
import com.fastcode.timesheetapp1.domain.core.timesheetdetails.*;
...
public class TimesheetdetailsAppServiceTest {
	...
	public void findTimesheetdetailsById_IdIsNotNullAndIdExists_ReturnTimesheetdetails() {
		...
		Optional<TimesheetdetailsEntity> timesheetdetailsOptional = Optional.of((TimesheetdetailsEntity) timesheetdetails);
		Mockito.when(_timesheetdetailsRepository.findById(anyLong())).thenReturn(timesheetdetailsOptional);
		
	    Assertions.assertThat(_appService.findById(ID )).isEqualTo(_mapper.timesheetdetailsEntityToFindTimesheetdetailsByIdOutput(timesheetdetails));
	}
    ...
    public void createTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExist_StoreTimesheetdetails() { 
        ...
        Mockito.when(_mapper.createTimesheetdetailsInputToTimesheetdetailsEntity(any(CreateTimesheetdetailsInput.class))).thenReturn(timesheetdetailsEntity); 
        Mockito.when(_timesheetdetailsRepository.save(any(TimesheetdetailsEntity.class))).thenReturn(timesheetdetailsEntity);

	   	Assertions.assertThat(_appService.create(timesheetdetailsInput)).isEqualTo(_mapper.timesheetdetailsEntityToCreateTimesheetdetailsOutput(timesheetdetailsEntity));
	...
	public void createTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExistAndChildIsNullAndChildIsNotMandatory_StoreTimesheetdetails() {
		...
		Mockito.when(_mapper.createTimesheetdetailsInputToTimesheetdetailsEntity(any(CreateTimesheetdetailsInput.class))).thenReturn(timesheetdetailsEntity);
		Mockito.when(_timesheetdetailsRepository.save(any(TimesheetdetailsEntity.class))).thenReturn(timesheetdetailsEntity);
	    Assertions.assertThat(_appService.create(timesheetdetails)).isEqualTo(_mapper.timesheetdetailsEntityToCreateTimesheetdetailsOutput(timesheetdetailsEntity)); 
	}
	...
	public void updateTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExistAndChildIsNullAndChildIsNotMandatory_ReturnUpdatedTimesheetdetails() {
		...
		Optional<TimesheetdetailsEntity> timesheetdetailsOptional = Optional.of((TimesheetdetailsEntity) timesheetdetailsEntity);
		Mockito.when(_timesheetdetailsRepository.findById(anyLong())).thenReturn(timesheetdetailsOptional);
		
		Mockito.when(_mapper.updateTimesheetdetailsInputToTimesheetdetailsEntity(any(UpdateTimesheetdetailsInput.class))).thenReturn(timesheetdetailsEntity);
		Mockito.when(_timesheetdetailsRepository.save(any(TimesheetdetailsEntity.class))).thenReturn(timesheetdetailsEntity);
		Assertions.assertThat(_appService.update(ID,timesheetdetails)).isEqualTo(_mapper.timesheetdetailsEntityToUpdateTimesheetdetailsOutput(timesheetdetailsEntity));
	}
	...
	public void find_ListIsEmpty_ReturnList() throws Exception {
		...
		Mockito.when(_timesheetdetailsRepository.findAll(any(Predicate.class),any(Pageable.class))).thenReturn(foundPage);
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QTimesheetdetailsEntity.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetTask_IfTimesheetdetailsIdAndTaskIdIsNotNullAndTimesheetdetailsExists_ReturnTask() {
		...
		Assertions.assertThat(_appService.getTask(ID)).isEqualTo(_mapper.taskEntityToGetTaskOutput(taskEntity, timesheetdetails));
	}
	...
	public void GetTimeofftype_IfTimesheetdetailsIdAndTimeofftypeIdIsNotNullAndTimesheetdetailsExists_ReturnTimeofftype() {
		...
		Assertions.assertThat(_appService.getTimeofftype(ID)).isEqualTo(_mapper.timeofftypeEntityToGetTimeofftypeOutput(timeofftypeEntity, timesheetdetails));
	}
	...
	public void GetTimesheet_IfTimesheetdetailsIdAndTimesheetIdIsNotNullAndTimesheetdetailsExists_ReturnTimesheet() {
		...
		Assertions.assertThat(_appService.getTimesheet(ID)).isEqualTo(_mapper.timesheetEntityToGetTimesheetOutput(timesheetEntity, timesheetdetails));
	}
