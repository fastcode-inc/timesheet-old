...
public class TimesheetstatusAppServiceTest {
	...
	public void findTimesheetstatusById_IdIsNotNullAndIdExists_ReturnTimesheetstatus() {
	    ...
	    Assertions.assertThat(_appService.findById(ID )).isEqualTo(_mapper.timesheetstatusEntityToFindTimesheetstatusByIdOutput(timesheetstatus));
	}
    ...
    public void createTimesheetstatus_TimesheetstatusIsNotNullAndTimesheetstatusDoesNotExist_StoreTimesheetstatus() { 
        ...
        Mockito.when(_mapper.createTimesheetstatusInputToTimesheetstatusEntity(any(CreateTimesheetstatusInput.class))).thenReturn(timesheetstatusEntity); 
        Mockito.when(_timesheetstatusRepository.save(any(TimesheetstatusEntity.class))).thenReturn(timesheetstatusEntity);

	   	Assertions.assertThat(_appService.create(timesheetstatusInput)).isEqualTo(_mapper.timesheetstatusEntityToCreateTimesheetstatusOutput(timesheetstatusEntity));
	...
	public void updateTimesheetstatus_TimesheetstatusIdIsNotNullAndIdExists_ReturnUpdatedTimesheetstatus() {
		...
		Optional<TimesheetstatusEntity> timesheetstatusOptional = Optional.of((TimesheetstatusEntity) timesheetstatusEntity);
		Mockito.when(_timesheetstatusRepository.findById(anyLong())).thenReturn(timesheetstatusOptional);
	 		
		Mockito.when(_mapper.updateTimesheetstatusInputToTimesheetstatusEntity(any(UpdateTimesheetstatusInput.class))).thenReturn(timesheetstatusEntity);
		Mockito.when(_timesheetstatusRepository.save(any(TimesheetstatusEntity.class))).thenReturn(timesheetstatusEntity);
		Assertions.assertThat(_appService.update(ID,timesheetstatus)).isEqualTo(_mapper.timesheetstatusEntityToUpdateTimesheetstatusOutput(timesheetstatusEntity));
	}
	...
	public void find_ListIsEmpty_ReturnList() throws Exception {
		...
		Mockito.when(_timesheetstatusRepository.findAll(any(Predicate.class),any(Pageable.class))).thenReturn(foundPage);
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QTimesheetstatusEntity.class), any(HashMap.class), any(HashMap.class));
