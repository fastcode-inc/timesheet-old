...
public class UsersAppServiceTest {
	...
	public void findUsersById_IdIsNotNullAndIdExists_ReturnUsers() {
		...
		Assertions.assertThat(_appService.findById(ID )).isEqualTo(_mapper.usersEntityToFindUsersByIdOutput(users,userspreference));
	}
    ...
    public void createUsers_UsersIsNotNullAndUsersDoesNotExist_StoreUsers() { 
		...
		Assertions.assertThat(_appService.create(usersInput)).isEqualTo(_mapper.usersEntityToCreateUsersOutput(usersEntity,userspreference)); 
