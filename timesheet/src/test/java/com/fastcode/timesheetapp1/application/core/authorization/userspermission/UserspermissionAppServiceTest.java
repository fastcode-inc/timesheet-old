...
public class UserspermissionAppServiceTest {
	...
	public void findUserspermissionById_IdIsNotNullAndIdExists_ReturnUserspermission() {
	    ...
	    Assertions.assertThat(_appService.findById(userspermissionId)).isEqualTo(_mapper.userspermissionEntityToFindUserspermissionByIdOutput(userspermission));
	}
    ...
    public void createUserspermission_UserspermissionIsNotNullAndUserspermissionDoesNotExist_StoreUserspermission() { 
        ...
        Mockito.when(_mapper.createUserspermissionInputToUserspermissionEntity(any(CreateUserspermissionInput.class))).thenReturn(userspermissionEntity); 
        Mockito.when(_userspermissionRepository.save(any(UserspermissionEntity.class))).thenReturn(userspermissionEntity);

	    CreateUserspermissionOutput output = new CreateUserspermissionOutput();
        Mockito.when(_mapper.userspermissionEntityToCreateUserspermissionOutput(any(UserspermissionEntity.class))).thenReturn(output);

	   	Assertions.assertThat(_appService.create(userspermissionInput)).isEqualTo(_mapper.userspermissionEntityToCreateUserspermissionOutput(userspermissionEntity));
	...
	public void createUserspermission_UserspermissionIsNotNullAndUserspermissionDoesNotExistAndChildIsNullAndChildIsMandatory_ReturnNull() {
		...
		Mockito.when(_mapper.createUserspermissionInputToUserspermissionEntity(any(CreateUserspermissionInput.class))).thenReturn(null); 
	...
	public void updateUserspermission_UserspermissionIsNotNullAndUserspermissionDoesNotExistAndChildIsNullAndChildIsMandatory_ReturnNull() {
		...
		UserspermissionEntity userspermissionEntity = mock(UserspermissionEntity.class); 
     	...
     	Optional<UserspermissionEntity> userspermissionOptional = Optional.of((UserspermissionEntity) userspermissionEntity);
		Mockito.when(_userspermissionRepository.findById(any(UserspermissionId.class))).thenReturn(userspermissionOptional);
		
		Mockito.when(_mapper.updateUserspermissionInputToUserspermissionEntity(any(UpdateUserspermissionInput.class))).thenReturn(userspermissionEntity); 
	...
	public void updateUserspermission_UserspermissionIdIsNotNullAndIdExists_ReturnUpdatedUserspermission() {
		...
		Mockito.when(_mapper.updateUserspermissionInputToUserspermissionEntity(any(UpdateUserspermissionInput.class))).thenReturn(userspermissionEntity);
		Mockito.when(_userspermissionRepository.save(any(UserspermissionEntity.class))).thenReturn(userspermissionEntity);
		Assertions.assertThat(_appService.update(userspermissionId,userspermission)).isEqualTo(_mapper.userspermissionEntityToUpdateUserspermissionOutput(userspermissionEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QUserspermissionEntity.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetPermission_IfUserspermissionIdAndPermissionIdIsNotNullAndUserspermissionExists_ReturnPermission() {
		...
		Assertions.assertThat(_appService.getPermission(userspermissionId)).isEqualTo(_mapper.permissionEntityToGetPermissionOutput(permissionEntity, userspermission));
	}
	...
	public void GetUsers_IfUserspermissionIdAndUsersIdIsNotNullAndUserspermissionExists_ReturnUsers() {
		...
		Assertions.assertThat(_appService.getUsers(userspermissionId)).isEqualTo(_mapper.usersEntityToGetUsersOutput(usersEntity, userspermission));
	}
