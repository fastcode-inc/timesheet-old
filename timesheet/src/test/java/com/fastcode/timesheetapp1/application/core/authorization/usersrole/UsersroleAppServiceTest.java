...
import com.fastcode.timesheetapp1.domain.core.authorization.usersrole.*;
...
import com.fastcode.timesheetapp1.domain.core.authorization.usersrole.QUsersroleEntity;
...
public class UsersroleAppServiceTest {
	...
	public void findUsersroleById_IdIsNotNullAndIdExists_ReturnUsersrole() {
	    ...
	    Assertions.assertThat(_appService.findById(usersroleId)).isEqualTo(_mapper.usersroleEntityToFindUsersroleByIdOutput(usersrole));
	}
    ...
    public void createUsersrole_UsersroleIsNotNullAndUsersroleDoesNotExist_StoreUsersrole() { 
        ...
        Mockito.when(_mapper.createUsersroleInputToUsersroleEntity(any(CreateUsersroleInput.class))).thenReturn(usersroleEntity); 
        Mockito.when(_usersroleRepository.save(any(UsersroleEntity.class))).thenReturn(usersroleEntity);

	   	Assertions.assertThat(_appService.create(usersroleInput)).isEqualTo(_mapper.usersroleEntityToCreateUsersroleOutput(usersroleEntity));
	...
	public void updateUsersrole_UsersroleIsNotNullAndUsersroleDoesNotExistAndChildIsNullAndChildIsMandatory_ReturnNull() {
		...
		Mockito.when(_mapper.updateUsersroleInputToUsersroleEntity(any(UpdateUsersroleInput.class))).thenReturn(usersroleEntity); 
	...
	public void updateUsersrole_UsersroleIdIsNotNullAndIdExists_ReturnUpdatedUsersrole() {
		...
		Mockito.when(_mapper.updateUsersroleInputToUsersroleEntity(any(UpdateUsersroleInput.class))).thenReturn(usersroleEntity);
		Mockito.when(_usersroleRepository.save(any(UsersroleEntity.class))).thenReturn(usersroleEntity);
		Assertions.assertThat(_appService.update(usersroleId,usersrole)).isEqualTo(_mapper.usersroleEntityToUpdateUsersroleOutput(usersroleEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QUsersroleEntity.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetRole_IfUsersroleIdAndRoleIdIsNotNullAndUsersroleExists_ReturnRole() {
		...
		Assertions.assertThat(_appService.getRole(usersroleId)).isEqualTo(_mapper.roleEntityToGetRoleOutput(roleEntity, usersrole));
	}
	...
	public void GetUsers_IfUsersroleIdAndUsersIdIsNotNullAndUsersroleExists_ReturnUsers() {
		...
		Assertions.assertThat(_appService.getUsers(usersroleId)).isEqualTo(_mapper.usersEntityToGetUsersOutput(usersEntity, usersrole));
	}
