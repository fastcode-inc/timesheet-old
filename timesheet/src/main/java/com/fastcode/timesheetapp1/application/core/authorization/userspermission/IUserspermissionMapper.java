...
public interface IUserspermissionMapper {
   ...
   UserspermissionEntity createUserspermissionInputToUserspermissionEntity(CreateUserspermissionInput userspermissionDto);
   ...
   CreateUserspermissionOutput userspermissionEntityToCreateUserspermissionOutput(UserspermissionEntity entity);
    ...
    UserspermissionEntity updateUserspermissionInputToUserspermissionEntity(UpdateUserspermissionInput userspermissionDto);
   ...
   GetPermissionOutput permissionEntityToGetPermissionOutput(PermissionEntity permission, UserspermissionEntity foundUserspermission);
