...
public class TaskAppService implements ITaskAppService {
	...
	@NonNull protected final IProjectRepository _projectRepository;

	@Qualifier("ITaskMapperImpl")
	@NonNull protected final ITaskMapper mapper;
	...
	protected BooleanBuilder searchKeyValuePair(QTaskEntity task, Map<String,SearchFields> map,Map<String,String> joinColumns) {
			 	...
			 	if(details.getValue().getOperator().equals("contains")) {
					...
					builder.and(task.id.ne(Long.valueOf(details.getValue().getSearchValue())));
				  	...
				  	if(StringUtils.isNumeric(details.getValue().getStartingValue()) && StringUtils.isNumeric(details.getValue().getEndingValue())) {
                	   builder.and(task.id.between(Long.valueOf(details.getValue().getStartingValue()), Long.valueOf(details.getValue().getEndingValue())));
