...
public class UsertaskAppService implements IUsertaskAppService {
	...
	@NonNull protected final IUsertaskRepository _usertaskRepository;
	...
	@NonNull protected final IUsertaskMapper mapper;
...
//		        list.get(i).replace("%20","").trim().equals("lastname") ||
	...
	protected BooleanBuilder searchKeyValuePair(QUsertaskEntity usertask, Map<String,SearchFields> map,Map<String,String> joinColumns) {
