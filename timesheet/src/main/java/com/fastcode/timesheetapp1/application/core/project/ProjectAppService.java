...
public class ProjectAppService implements IProjectAppService {
	...
	@NonNull protected final IProjectMapper mapper;
	...
	protected BooleanBuilder searchKeyValuePair(QProjectEntity project, Map<String,SearchFields> map,Map<String,String> joinColumns) {
