...
public class TimeofftypeAppService implements ITimeofftypeAppService {
	...
	@NonNull protected final ITimeofftypeMapper mapper;
	...
	protected BooleanBuilder searchKeyValuePair(QTimeofftypeEntity timeofftype, Map<String,SearchFields> map,Map<String,String> joinColumns) {
			 	...
			 	if(details.getValue().getOperator().equals("contains")) {
					...
					builder.and(timeofftype.id.ne(Long.valueOf(details.getValue().getSearchValue())));
				  	...
				  	if(StringUtils.isNumeric(details.getValue().getStartingValue()) && StringUtils.isNumeric(details.getValue().getEndingValue())) {
                	   builder.and(timeofftype.id.between(Long.valueOf(details.getValue().getStartingValue()), Long.valueOf(details.getValue().getEndingValue())));
