...
public class TimesheetstatusController {
	...
	public ResponseEntity<CreateTimesheetstatusOutput> create(@RequestBody @Valid CreateTimesheetstatusInput timesheetstatus) {
	...
	public void delete(@PathVariable String id) {
    	...
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a timesheetstatus with a id=%s", id)));
	...
	public ResponseEntity<UpdateTimesheetstatusOutput> update(@PathVariable String id, @RequestBody @Valid UpdateTimesheetstatusInput timesheetstatus) {

	    FindTimesheetstatusByIdOutput currentTimesheetstatus = _timesheetstatusAppService.findById(Long.valueOf(id));
		Optional.ofNullable(currentTimesheetstatus).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. Timesheetstatus with id=%s not found.", id)));
