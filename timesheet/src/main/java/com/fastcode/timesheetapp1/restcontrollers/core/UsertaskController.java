...
public class UsertaskController {
	...
	public void delete(@PathVariable String id) {
		...
		Optional.ofNullable(usertaskid).orElseThrow(() -> new EntityNotFoundException(String.format("Invalid id=%s", id)));

		FindUsertaskByIdOutput output = _usertaskAppService.findById(usertaskid);
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a usertask with a id=%s", id)));
	...
	public ResponseEntity<UpdateUsertaskOutput> update(@PathVariable String id, @RequestBody @Valid UpdateUsertaskInput usertask) {
		...
		Optional.ofNullable(currentUsertask).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. Usertask with id=%s not found.", id)));
