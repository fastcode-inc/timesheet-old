package com.fastcode.timesheetapp1.addons.scheduler.application.job;
...
import com.fastcode.timesheetapp1.Timesheetapp1Application;
import com.fastcode.timesheetapp1.addons.scheduler.constants.QuartzConstants;
import com.fastcode.timesheetapp1.addons.scheduler.domain.job.JobEntity;
import com.fastcode.timesheetapp1.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.timesheetapp1.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.timesheetapp1.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.timesheetapp1.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.timesheetapp1.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
import com.fastcode.timesheetapp1.addons.scheduler.CGenClassLoader;
...
public class JobAppService implements IJobAppService {
	...
	public List<String> listAllJobClasses() throws URISyntaxException {
		...
		URI uri = Timesheetapp1Application.class.getResource("/").toURI();
