...
public interface IDashboardversionreportRepository extends JpaRepository<DashboardversionreportEntity, DashboardversionreportId>,QuerydslPredicateExecutor<DashboardversionreportEntity> {
	...
	List<DashboardversionreportEntity> findByDashboardIdAndVersionAndUsersId(Long dashboardId, String version, Long userId);
	...
	List<DashboardversionreportEntity> findByDashboardIdAndVersionAndUsersIdInDesc(Long id, String version, Long userId);
	...
	List<DashboardversionreportEntity> findByIdIfUsersIdNotSame(Long dashboardId,Long reportId, Long userId, String version);
