package com.fastcode.timesheetapp1.addons.reporting.application.dashboard;

import com.fastcode.timesheetapp1.addons.reporting.application.dashboard.dto.*;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.IDashboardversionAppService;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.IDashboardversionMapper;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.dto.CreateDashboardversionInput;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.dto.CreateDashboardversionOutput;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionInput;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionOutput;
import com.fastcode.timesheetapp1.addons.reporting.application.dashboardversionreport.IDashboardversionreportAppService;
import com.fastcode.timesheetapp1.addons.reporting.application.report.IReportAppService;
import com.fastcode.timesheetapp1.addons.reporting.application.report.IReportMapper;
import com.fastcode.timesheetapp1.addons.reporting.application.report.dto.CreateReportInput;
import com.fastcode.timesheetapp1.addons.reporting.application.report.dto.CreateReportOutput;
...
import com.fastcode.timesheetapp1.addons.reporting.domain.dashboard.IDashboardRepository;
...
import com.fastcode.timesheetapp1.addons.reporting.domain.dashboard.QDashboardEntity;
...
public class DashboardAppService implements IDashboardAppService {
	...
	public void delete(Long dashboardId,  Long userId) {
		...
		existing.removeDashboardversion(_dashboardversionRepository.findById(new DashboardversionId(userId, dashboardId, "running")).get());
	...
	public void deleteReportFromDashboard(Long dashboardId, Long reportId,  Long userId) {
		...
		DashboardversionreportEntity existing = _reportDashboardRepository.findById(new DashboardversionreportId(dashboardId, userId, "running", reportId)).get();
	...
	{
		List<DashboardversionreportEntity> reportDashboardList = _reportDashboardRepository.findByDashboardIdAndVersionAndUsersId(dashboardId, version, userId);
	...
	public FindDashboardByIdOutput findByDashboardIdAndUsersId(Long dashboardId,  Long userId, String version) {
		...
		DashboardEntity foundDashboard = _dashboardRepository.findByDashboardIdAndUsersId(dashboardId, userId);
		if (foundDashboard == null)  
			return null ; 
	...
	public FindDashboardByIdOutput publishDashboard( Long userId, Long dashboardId) {
		...
		List<DashboardversionreportEntity> dashboardreportList  = _reportDashboardRepository.findByDashboardIdAndVersionAndUsersId(dashboardId, "running", userId);
		...
		List<DashboardversionreportEntity> dashboardPublishedreportList  = _reportDashboardRepository.findByDashboardIdAndVersionAndUsersId(dashboardId, "published", userId);
	...
	public FindDashboardByIdOutput refreshDashboard( Long userId, Long dashboardId) {
		...
		if(foundDashboard !=null && foundDashboard.getUsers() !=null && foundDashboard.getUsers().getId() == userId) {
			...
			List<DashboardversionreportEntity> dvrList = _reportDashboardRepository.findByDashboardIdAndVersionAndUsersId(dashboardId, "published",userId);
			for(DashboardversionreportEntity dvr : dvrList)
			{
	...
	public List<FindDashboardByIdOutput> find(SearchCriteria search, Pageable pageable) throws Exception  {
		...
		while (dashboardIterator.hasNext()) {
			...
			DashboardversionEntity dashboardVersion =_dashboardversionRepository.findById(new DashboardversionId(dashboard.getUsers().getId(),dashboard.getId(), "running")).orElse(null);
			FindDashboardByIdOutput dashboardOutput  = mapper.dashboardEntitiesToFindDashboardByIdOutput(dashboard, dashboardVersion); 
			DashboardversionEntity publishedversion = _dashboardversionRepository.findById(new DashboardversionId(dashboard.getUsers().getId(), dashboard.getId(), "published")).orElse(null);
